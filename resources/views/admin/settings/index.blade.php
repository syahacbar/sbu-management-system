    ...
    <div class="space-y-6">
        ...
        <section class="rounded-lg border border-slate-200 bg-white">
            <div class="border-b border-slate-200 px-5 py-4">
                <h3 class="text-lg font-semibold text-slate-950">Pengaturan Sistem</h3>
                <p class="mt-1 text-sm text-slate-500">Kelola konfigurasi aplikasi secara global.</p>
            </div>
                ...
                <nav class="-mb-px flex gap-6 overflow-x-auto">
                    @foreach ($tabs as $key => $label)
                        <a
                            ...
                            class="shrink-0 border-b-2 px-1 py-4 text-sm font-medium transition {{ $tab === $key ? 'border-emerald-700 text-emerald-700' : 'border-transparent text-slate-500 hover:border-slate-300 hover:text-slate-700' }}"
                        >
                            {{ $label }}
                        </a>
                    @endforeach
                ...
                @switch($tab)
                    @case('app-profile')
                        <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="grid gap-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-2 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm shadow-sm outline-none transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100"
                                        required
                                    >
                                    @error('app_name')
                                ...
                                <div>
                                    <label for="app_company_name" class="block text-sm font-medium text-slate-700">Nama Perusahaan</label>
                                    <input
                                        id="app_company_name"
                                ...
                                <div>
                                    <label for="app_logo" class="block text-sm font-medium text-slate-700">Logo Aplikasi</label>
                                    <input
                                        id="app_logo"
                                        name="app_logo"
                                        type="file"
                                        accept="image/png,image/jpeg,image/svg+xml"
                                        class="mt-2 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm shadow-sm outline-none transition file:mr-3 file:rounded file:border-0 file:bg-emerald-50 file:px-3 file:py-1 file:text-sm file:font-semibold file:text-emerald-700 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100"
                                    >
                                    @if (!empty($settings['app_logo']))
                                        <div class="mt-2 flex items-center gap-2">
                                            <img src="{{ asset('storage/' . $settings['app_logo']) }}" class="h-10 w-auto rounded border border-slate-200">
                                ...
                                <div>
                                    <label for="app_favicon" class="block text-sm font-medium text-slate-700">Favicon</label>
                                    <input
                                        id="app_favicon"
                                        name="app_favicon"
                                        type="file"
                                    ...
                                    @if (!empty($settings['app_favicon']))
                                        <div class="mt-2 flex items-center gap-2">
                                            <img src="{{ asset('storage/' . $settings['app_favicon']) }}" class="h-8 w-auto rounded border border-slate-200">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="app_address" class="block text-sm font-medium text-slate-700">Alamat</label>
                                    <textarea
                                        id="app_address"
                                        name="app_address"
                                        rows="2"
                                ...
                                <div>
                                    <label for="app_phone" class="block text-sm font-medium text-slate-700">Telepon</label>
                                    <input
                                        id="app_phone"
                                        name="app_phone"
                                        type="text"
                                ...
                                <div>
                                    <label for="app_email" class="block text-sm font-medium text-slate-700">Email</label>
                                    <input
                                        id="app_email"
                                        name="app_email"
                                        type="email"
                                ...
                                <div>
                                    <label for="app_footer" class="block text-sm font-medium text-slate-700">Footer</label>
                                    <input
                                        id="app_footer"
                                        name="app_footer"
                                        type="text"
                            ...
                            <div class="flex justify-end border-t border-slate-200 pt-5">
                                <button type="submit" class="rounded-md bg-emerald-700 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:ring-offset-2">
                                    Simpan Pengaturan
                                </button>
                            </div>
                        </form>
                    ...
                    @case('documents')
                        <form method="POST" action="{{ route('settings.update') }}" class="space-y-6">
                            ...
                            <div class="grid gap-6 sm:grid-cols-2">
                                <div>
                                    <label for="doc_city_default" class="block text-sm font-medium text-slate-700">Kota Tempat TTD Default</label>
                                    <input
                                        id="doc_city_default"
                                ...
                                <div>
                                    <label for="doc_number_format" class="block text-sm font-medium text-slate-700">Format Nomor Dokumen</label>
                                    <input
                                ...
                                <div>
                                    <label for="app_prefix_number" class="block text-sm font-medium text-slate-700">Prefix Nomor Pengajuan</label>
                                    <input
                                ...
                                <div>
                                    <label for="doc_default_year" class="block text-sm font-medium text-slate-700">Tahun Default</label>
                                    <input
                                        id="doc_default_year"
                                ...
                                <div>
                                    <label for="doc_date_format" class="block text-sm font-medium text-slate-700">Format Tanggal Indonesia</label>
                                    <input
                                        id="doc_date_format"
                                ...
                                <div>
                                    <label for="doc_paper_size" class="block text-sm font-medium text-slate-700">Ukuran Kertas Default</label>
                                    <select
                                        id="doc_paper_size"
                                        name="doc_paper_size"
                                        class="mt-2 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm shadow-sm outline-none transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100"
                                ...
                                <div>
                                    <label for="doc_margin_pdf" class="block text-sm font-medium text-slate-700">Margin PDF</label>
                                    <input
                                        id="doc_margin_pdf"
                                        name="doc_margin_pdf"
                                        type="text"
                                ...
                                <div>
                                    <label for="doc_orientation" class="block text-sm font-medium text-slate-700">Orientation Default</label>
                                    <select
                                        id="doc_orientation"
                    ...
                    @case('storage')
                        <form method="POST" action="{{ route('settings.update') }}" class="space-y-6">
                            ...
                            <div class="grid gap-6 sm:grid-cols-2">
                                <div>
                                    <label for="storage_upload_folder" class="block text-sm font-medium text-slate-700">Folder Upload</label>
                                    <input
                                ...
                                <div>
                                    <label for="storage_archive_folder" class="block text-sm font-medium text-slate-700">Folder Arsip PDF</label>
                                    <input
                                ...
                                <div>
                                    <label for="storage_max_upload_size" class="block text-sm font-medium text-slate-700">Maksimal Upload File (MB)</label>
                                    <input
                                ...
                                <div>
                                    <label for="storage_allowed_types" class="block text-sm font-medium text-slate-700">Jenis File Yang Diizinkan</label>
                                    <input
                                    ...
                                    @error('storage_allowed_types')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-slate-400">Pisahkan dengan koma, tanpa spasi. Contoh: pdf,doc,jpg</p>
                                </div>
                            </div>
                    ...
                    @case('backup')
                        <div class="space-y-6">
                            <form method="POST" action="{{ route('settings.update') }}" class="space-y-6">
                                ...
                                <div class="grid gap-6 sm:grid-cols-2">
                                    <div>
                                        <label for="backup_db_folder" class="block text-sm font-medium text-slate-700">Folder Backup Database</label>
                                        <input
                                            id="backup_db_folder"
                                    ...
                                    <div>
                                        <label for="backup_doc_folder" class="block text-sm font-medium text-slate-700">Folder Backup Dokumen</label>
                                        <input
                            ...
                            <div class="rounded-lg border border-slate-200 bg-slate-50 p-5">
                                <h4 class="text-sm font-semibold text-slate-950">Aksi Backup</h4>
                                <p class="mt-1 text-xs text-slate-500">Jalankan backup secara manual.</p>
                                <div class="mt-4 flex flex-wrap gap-3">
                                    <form method="POST" action="{{ route('settings.backup.database') }}">
                                        @csrf
                                        <button type="submit" class="rounded-md bg-slate-900 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-600 focus:ring-offset-2">
                                            Backup Database
                                        </button>
                                    </form>
                                    <form method="POST" action="{{ route('settings.backup.storage') }}">
                                        @csrf
                                        <button type="submit" class="rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2">
                                            Backup Storage
                                        </button>
                                    </form>
                                </div>
