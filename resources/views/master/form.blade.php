<x-layouts.admin :title="$item ? 'Edit '.$resource['title'] : 'Tambah '.$resource['title']">
    <section class="max-w-3xl rounded-lg border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800">
        <div class="border-b border-slate-200 p-5 dark:border-slate-700">
            ...
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Isi data referensi global. Data ini tidak bergantung pada perusahaan.</p>
        </div>
        ...
        >
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    <label for="code" class="block text-sm font-medium text-slate-700 dark:text-slate-300">Kode</label>
                    <input
                        id="code"
                        name="code"
                        type="text"
