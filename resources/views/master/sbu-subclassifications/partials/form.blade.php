<form method="POST" action="{{ $action }}" class="space-y-5 p-5">
    ...
    <div>
        <label for="master_sbu_classification_id" class="block text-sm font-medium text-slate-700">Klasifikasi SBU</label>
        <select
    ...
    <div class="grid gap-5 md:grid-cols-2">
        <div>
            <label for="code" class="block text-sm font-medium text-slate-700">Kode Subklasifikasi</label>
            <input
                id="code"
                name="code"
                type="text"
    ...
    <div>
        <label for="name" class="block text-sm font-medium text-slate-700">Nama Subklasifikasi</label>
        <input
            id="name"
            name="name"
            type="text"
