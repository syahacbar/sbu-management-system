<form method="POST" action="{{ $action }}" class="space-y-5 p-5">
    ...
    <div class="grid gap-5 md:grid-cols-2">
        <div>
            <label for="code" class="block text-sm font-medium text-slate-700">Kode Klasifikasi</label>
            <input
                id="code"
                name="code"
                type="text"
    ...
    <div>
        <label for="name" class="block text-sm font-medium text-slate-700">Nama Klasifikasi</label>
        <input
            id="name"
            name="name"
            type="text"
