...
<head>
    <meta charset="UTF-8">
    <title>Surat Pernyataan Peralatan BS - {{ $company->name }}</title>
    <style>
        @page {
            size: a4;
            margin: 20mm;
...
<body>
    ...
    <div class="header">
        <div class="header-title">Surat Pernyataan Pemenuhan Peralatan BS</div>
        <div class="header-subtitle">Sistem Informasi Pengajuan Sertifikat Badan Usaha (SBU)</div>
    </div>

    <div class="doc-title">
        SURAT PERNYATAAN KELAYAKAN DAN PEMENUHAN PERALATAN (BS)
    </div>
    ...
    <table class="table-data">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="7" class="no-data">Belum ada peralatan konstruksi kategori Sipil (BS) terdaftar pada pengajuan aktif ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
