    ...
    <div class="space-y-5">
        ...
        <section class="rounded-lg border border-slate-200 bg-white">
            <div class="flex flex-col gap-4 border-b border-slate-200 p-5 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-slate-950">Daftar Perusahaan</h3>
                    <p class="mt-1 text-sm text-slate-500">Setiap perusahaan memiliki workspace administrasi SBU sendiri.</p>
                </div>

                <a href="{{ route('companies.create') }}" class="inline-flex items-center justify-center rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800">
                    Tambah Perusahaan
                </a>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        @forelse ($companies as $company)
                            <tr>
                                <td class="px-5 py-4">
                                    ...
                                    <p class="mt-1 text-xs text-slate-500">{{ $company->email ?: '-' }}</p>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-5 py-10 text-center text-slate-500">Belum ada perusahaan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
